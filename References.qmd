...
Data CSV: - [Download file1.csv](suicide-rates-all.csv){download="suicide-rates-all.csv"} - [Download file2.csv](suicide-rates-by-age.csv){download="suicide-rates-by-age.csv"}
