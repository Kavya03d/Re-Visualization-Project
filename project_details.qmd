...
#### **For Full project explanation below is the video**

{{< video https://www.youtube.com/watch?v=MDNMmd_fKms>}}

### **OLD VISUALIZATION:**

### ![](suicide-rate-image-mdb.svg){width="732"}
...
![](suicide-rates-by-age-who-mdb.svg){width="765"}
...
# Load the CSV file
children_data <- read.csv("/Users/kiran/Downloads/suicide-rates-by-age.csv")
